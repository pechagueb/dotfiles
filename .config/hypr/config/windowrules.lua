...
-- Reglas para el explorador de archivos predeterminado (flotante, centrado y redimensionado)
hl.window_rule({
...
-- Reglas para el visualizador de PDF (flotante, centrado y redimensionado)
hl.window_rule({
    match = { class = ".*" .. PDFVIEWER .. ".*" },
    float = true,
    center = true,
    size = { 1650, 900 }
})
