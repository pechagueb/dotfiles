...
hl.bind(mainMod .. " + SHIFT + B",  hl.dsp.exec_cmd(launchPrefix .. INCOGNITO))
hl.bind(mainMod .. " + M",          hl.dsp.exec_cmd(launchPrefix .. MAIL))
hl.bind(mainMod .. " + S",          hl.dsp.exec_cmd(launchPrefix .. "kshutdown"))
...
hl.bind(mainMod .. " + K",          hl.dsp.exec_cmd(launchPrefix .. KEYBINDINGS))
...
-- Red
hl.bind(mainMod .. " + CONTROL + N",          hl.dsp.exec_cmd(launchPrefix .. "nm-connection-editor"))
-- Sonido
hl.bind(mainMod .. " + CONTROL + S",          hl.dsp.exec_cmd(launchPrefix .. "pavucontrol"))
